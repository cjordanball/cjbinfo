		...
		<div className="row">
			...
			<div className="col-8">
				...
				<div className="row justify-content-md-center">
					...
					<h1>Updates</h1>
					<ul>
						<li>13 June 2017: Site is being launched!</li>
						<li>14 June 2017: Adding initial batch of problems and solutions to the ByteBites feature. Over the next few weeks I plan to add solutions to all problems, updated to employ the latest Javascript syntax (ES6 +), together with unit testing on all problems.
						</li>
					</ul>
